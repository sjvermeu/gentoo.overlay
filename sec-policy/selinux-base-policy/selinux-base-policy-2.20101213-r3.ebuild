...
src_unpack() {
	...
	epatch "${FILESDIR}"/fix-unprivuser-r3.patch
	epatch "${FILESDIR}"/fix-staff-r3.patch
	epatch "${FILESDIR}"/fix-sysadm-r3.patch
	epatch "${FILESDIR}"/fix-udev.patch
	epatch "${FILESDIR}"/fix-sudo.patch
	epatch "${FILESDIR}"/add-modules-r3.patch
	epatch "${FILESDIR}"/add-skype-r3.patch
