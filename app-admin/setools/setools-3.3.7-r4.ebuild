...
src_prepare() {
	...
	# Bug #424581, use MKDIRP_P when working with >=sys-devel/automake-1.12
	has_version ">=sys-devel/automake-1.12" && { find . -name 'Makefile.*' -exec sed -i -e 's:mkdir_p:MKDIR_P:g' {} + || die; }
